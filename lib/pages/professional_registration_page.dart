  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        // Navigation vers page de paiement avec l'ID temporaire et toutes les données
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) => PaymentPlanPage(
              ...
              professionalId: tempProfessionalId, // Utiliser l'ID temporaire
              categoryId: categoryId,
              categoryName: categoryName,
              categoryNameEn: categoryNameEn,
              // Passer toutes les données pour la création après paiement
              registrationData: {
                'businessName': _businessNameController.text,
                ...
                'couponCode': _couponCodeController.text.isNotEmpty
                    ...
                    : null,
                'couponDescription':
                    _couponDescriptionController.text.isNotEmpty
                    ? _couponDescriptionController.text
                    : null,
                'couponExpirationDate': _couponExpirationDate
                    ?.toIso8601String(),
